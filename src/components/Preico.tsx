         ...
         <div style={{ display: 'flex', flexDirection: 'column', marginTop:30, marginBottom:50}}>
                ...
                <div style={{ display: 'flex', justifyContent:'center',flexDirection: 'row', padding:0}}>
                     ...
                     <div style={{display:'flex', flexDirection: 'column', textAlign: 'right'}}>
                            ...
                            <p style={{fontSize:'8px', fontStyle: 'italic', marginTop:(-20)}}>FEBRUARY 1</p>
                     </div>
                    
                     <div style={{display:'flex',width:'54vw', marginLeft:'3vw' ,backgroundColor:'#ffffff', color:'#000000', alignContent:'center', alignItems: 'center', justifyContent:'center',}} onClick={() => console.log('ciao')}>
                     <a href="https://opensea.io/collection/besteam"><p style={{fontSize:'35px', marginTop:0,marginBottom:0,padding:0,fontFamily:'Bonn'}}>CLICK HERE!</p></a>
                     </div>
                 ...
                 <div style={{display:'flex', flexDirection: 'column', textAlign: 'right'}}>
                     ...
                     <div style={{display:'flex',width:'54vw', marginLeft:'3vw' ,backgroundColor:'#ffffff', color:'#000000', alignContent:'center', alignItems: 'center', justifyContent:'center',}}>
                     <Link to='/ico'><p style={{fontSize:'35px', marginTop:0,marginBottom:0,padding:0,fontFamily:'Bonn'}}>CLICK HERE!</p></Link>
                    </div>
                 </div>
            </div>
